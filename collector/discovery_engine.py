...
DISCOVERY_QUERIES = [
    ...
    # 🌙 심야 무알코올 / 야경 산책 / 심야 카페 / 야간 문화생활 큐레이션
    ("서울 한강공원 반포 여의도 달빛 야경 산책", "서울", "서초구", ["view", "romantic"]),
    ("서울 낙산공원 성곽길 야경 산책로", "서울", "종로구", ["view", "romantic"]),
    ("서울 종로 서촌 심야 북카페 심야서점", "서울", "종로구", ["healing", "retro"]),
    ("서울 마포 연남동 연희동 심야 카페 디저트", "서울", "마포구", ["trendy", "romantic"]),
    ("서울 강남 신사동 24시 심야 디저트 카페", "서울", "강남구", ["trendy", "romantic"]),
    ("서울 동대문 DDP 미디어아트 야간 전시", "서울", "중구", ["trendy", "view"]),
    ("서울 북악스카이웨이 팔각정 야경 드라이브", "서울", "종로구", ["view", "romantic"]),
    ("경기 수원 화성행궁 성곽 야간개장 달빛산책", "경기", "수원시", ["view", "romantic"]),
    ("경기 남양주 북한강 심야 드라이브 베이커리 카페", "경기", "남양주시", ["view", "healing"]),
    ("인천 송도 센트럴파크 문보트 야경 산책", "인천", "연수구", ["view", "romantic"]),
    ("대구 앞산전망대 케이블카 야경 명소", "영남", "남구", ["view", "romantic"]),
    ("부산 황령산 봉수대 광안대교 야경 전망대", "영남", "수영구", ["view", "romantic"]),
    ("경북 경주 동궁과월지 안압지 야간 라이트업", "영남", "경주시", ["view", "romantic"]),
    ("서울 성수동 팝업스토어 브랜드 전시 공간", "서울", "성동구", ["trendy", "active"]),
    ("서울 한남동 이태원 갤러리 복합문화공간 원데이클래스", "서울", "용산구", ["luxury", "trendy"]),
]
