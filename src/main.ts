...
const OUTDOOR_PATTERNS = /(?:공원|산책|둘레길|올레길|트레킹|피크닉|수목원|식물원\s*야외|유원지|해변|해수욕장|루프탑|카약|요트|패들|서핑|야외\s*전망대|야경산책|출렁다리|산성|성곽|숲|목장|농장|골프|해안|계곡|폭포|캠핑|글램핑|야시장|스카이워크|케이블카|드라이브|등산|휴양림|정원|전망대|유적|릉|묘|사찰|템플|선착장|항만|포구|분수|구름다리|광장|휴게소|보트|짚라인|짚트랙|등대|전망데크|보행교|대교|봉수대|야경길)/i;
